...
public class RecordService extends Service {
	...
	private void initRecordingData() {
		...
		myDb.loadPreferences();
		switch(myDb.getStatus()) {
		case FINISHED:
		...
		case RECORDING:
			...
			myDb.setStatus(DBAdapter.Status.PAUSED);
			myDb.savePreferences();
			setStatus(Status.PAUSE);
			break;
		case NOT_STARTED:
	...
	private String formatTimeFloating(double time_ms) {
		...
		double seconds = (time_s_mod_min);		//Modified to get better precision to the 1/100th of second  
	...
	public class Binder extends android.os.Binder {
		...
		public String getLastStep() {
			...
			return mService.getData().getLastStepInfoString();
		}
	...
	public void onDestroy() {
		...
		closeDB();
		//if(myDb != null) myDb.savePreferences();
		myDb = null;
...
//		}
	...
	private void saveDataOccasional() {
		if(myDb.getDelta() >= DATA_SAVE_DELTA_THRESHOLD) {
			myDb.savePreferences();
		}
	}
